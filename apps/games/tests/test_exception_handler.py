...
def _context() -> dict[str, MagicMock]:
...
class CustomAPIExceptionTests(TestCase):
    def test_creates_with_error_messages(self) -> None:
        ...
        self.assertEqual(exc.detail["code"], "GAME_NOT_FOUND")  # type: ignore[call-overload, index]
...
class CustomExceptionHandlerTests(TestCase):
    ...
    def test_igdb_not_found_returns_404(self) -> None:
    ...
    def test_igdb_rate_limit_returns_503(self) -> None:
    ...
    def test_igdb_server_error_returns_502(self) -> None:
    ...
    def test_exception_with_detail_and_status_code_attrs(self) -> None:
        """Test non-DRF exception that has detail and status_code attributes."""
        exc: Any = Exception("test")
    ...
    def test_custom_api_exception_handled(self) -> None:
